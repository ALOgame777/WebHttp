...
public class JsonParser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //// 구조체 인스턴스를 만든다.
        //UserData user1 = new UserData("이준수", 24, "수강생", true);
        ////user1.name = "이준수";
        ////user1.age = 24;
        ////user1.job = "수강생";
        ////user1.isMan = true; 
        //UserData user2 = new UserData("박원석", 44, "강사", true);
        //// 구조체 데이터를 json형태로 변환한다.
        ...
        //SaveJsonDate(jsonUser1, Application.dataPath, "이준수.json");
        //SaveJsonDate(jsonUser2, Application.dataPath, "박원석.json");
        #endregion

        #region json 파일을 읽어서 구조체 변수로 변환하기
        //string readString =  ReadJsonData(Application.dataPath, "박원석.json");
        //print(readString);
        //if (readString != "")
        //{
        ...
        #region json 리스트 만들기
        // 1. 구조체 데이터 여러개 만들기
        //UserData user1 = new UserData("이준수", 24, "Student", true);
        //UserData user2 = new UserData("박원석", 44, "Teacher", true);
        //UserData user3 = new UserData("장유진", 38, "Student", true);

        //// 2. 리스트에 json 데이터들을 담기
